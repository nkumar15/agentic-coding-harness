...
Use this skill only when `.claude/rules/project-conventions.md` says the project uses a
...
- Run commands from `.claude/process/gates.yaml` after resolving placeholders from project
  conventions.
