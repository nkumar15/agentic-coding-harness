...
| Rule Asset Gap | Tables / Markets | Required Asset / Class / Test | Related WP | Status | Evidence | Blocks |
| --- | --- | --- | --- | --- | --- | --- |
| `<gap>` | `<tables/markets>` | `<rule-impl/model/routing/parity/isolation>` | `<WP>` | `<pending/in-progress/complete/blocked>` | `<compile/load/test/report>` | `<WP or behavior>` |
