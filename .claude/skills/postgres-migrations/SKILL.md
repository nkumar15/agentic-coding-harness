...
Use this skill when `.claude/rules/project-conventions.md` says the project uses PostgreSQL.
...
- Run migration apply and rollback checks from `.claude/process/gates.yaml` or project conventions.
