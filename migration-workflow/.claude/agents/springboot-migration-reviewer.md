---
name: springboot-migration-reviewer
description: Reviews migrated Spring Boot code for correctness, contract compliance, parity readiness, and convention adherence.
tools:
  - Read
  - Glob
  - Grep
...
- Apply `.claude/skills/java-springboot/references/migration-implementation-checklist.md`.
- Apply `.claude/skills/java-springboot/templates/migration-progress-template.md`.
- Apply `.claude/skills/junit-parity-testing/references/testing-strategy.md`.
...
4. Check rule usage, tenant isolation, rule-source priority, and that every wired rule asset has
   ...
   model compatibility, fixture/test reconciliation, and tenant isolation before it was wired.
...
- tenant isolation and migrated rule asset usage
