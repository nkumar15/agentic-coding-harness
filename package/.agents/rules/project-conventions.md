...
The `checks_green` gate in `.agents/process/gates.yaml` should run the global verification commands
...
Replace placeholder gate commands in `.agents/process/gates.yaml` when adopting this package.
