...
Use this skill only when `.agents/rules/project-conventions.md` says the project uses pytest.
...
- Run the exact commands declared in `.agents/process/gates.yaml` after resolving placeholders from
  project conventions.
